package com.app.view.map 
{
    ...
    import flash.events.*;
	import res.map.*;
    public class DaimyoPopup extends DaimyoPopupMC
    {
        ...
        public function DaimyoPopup(param1, param2:String, param3:int = 0, param4:int = 0, param5:Function = null, param6:Boolean = true)
        {
            this.l = new Loader();
            this.main = param1;
            x = param3;
