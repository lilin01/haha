package com.app.view.game 
{
    import flash.events.*;
	import res.game.*;
    public class CreditsPopup extends CreditsPopupMC
    {
        ...
        public function CreditsPopup(param1, param2:Object, param3:int, param4:int, param5:Function, param6:Function = null)
        {
            this.main = param1;
            this.main.soundManager.loadSoundEffect("warning");
            x = param3;
            y = param4;
            confirmText.text = "" + Math.ceil(parseInt(param2.karma_value) * 2.5);
