package com.app.view.game 
{
    import flash.events.*;
	import res.game.*;
    public class AnnouncePopup extends AnnouncePopupMC
    {
        ...
        public function AnnouncePopup(param1, param2:String, param3:int = 0, param4:int = 0, param5:Function = null, param6:Boolean = true)
        {
            this.l = new Loader();
            this.main = param1;
            x = param3;
            ...
            alertText.height = alertText.numLines * (alertText.height - 10);
            alertText.y = Math.max(-(alertText.height >> 1), -105);
