...
function createKey()
{
	...
	"10001",
	"",
	""
	);
}

//createKey();
//alert( encryptedString(key, "helloword!"));

function encrypt()
{
	createKey();
	document.getElementById("en").value=encryptedString(_key, document.getElementById("en").value);
	return true;
}